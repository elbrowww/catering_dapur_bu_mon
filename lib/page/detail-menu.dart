...
class _DetailMenuPageState extends State<DetailMenuPage> {
  ...
  // Parse "Rp. 120.000" atau "Rp. 2.500/pcs" → integer 120000 / 2500
  ...
  void _tambahKeranjang() {
    KeranjangController.instance.tambah(
      ...
      harga: _parseHarga(widget.item.harga),
      ...
      SnackBar(
        content: Row(
          children: [
            ...
            Expanded(
              child: Text(
                '$_jumlah× ${widget.item.nama} ditambahkan ke keranjang!',
